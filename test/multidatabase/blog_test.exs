defmodule Multidatabase.BlogTest do
  use Multidatabase.DataCase

  alias Multidatabase.Blog

  describe "posts" do
    alias Multidatabase.Blog.Post

    @valid_attrs %{post: "some post", title: "some title"}
    @update_attrs %{post: "some updated post", title: "some updated title"}
    @invalid_attrs %{post: nil, title: nil}
